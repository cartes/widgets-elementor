            ...
            <div class="elpl-destacado-grid">
                ...
                <div class="elpl-load-more-wrap">
                    <button class="elpl-load-more-btn<?php echo esc_attr($no_more_class); ?>"
                        data-widget="elpl_archive_destacado_widget" data-grid=".elpl-destacado-side" data-category=""
                        data-per-page="<?php echo esc_attr($mobile_batch); ?>"
                        data-offset="<?php echo esc_attr($query_args['offset'] + $ppp); ?>" data-show-date="no"
                        data-show-excerpt="no" data-taxonomy="<?php echo esc_attr($taxonomy_slug); ?>"
                        data-term-id="<?php echo esc_attr($term_id); ?>" data-author-id="<?php echo esc_attr($author_id); ?>">
