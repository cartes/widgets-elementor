...
(function () {
  ...
  function initLoadMore() {
    document.addEventListener("click", function (e) {
      ...
      var showExcerpt = btn.getAttribute("data-show-excerpt") === "yes" ? "yes" : "no";
      ...
      var imageSize = btn.getAttribute("data-image-size") || "medium";
      var showTitle = btn.getAttribute("data-show-title") === "yes" ? "yes" : "no";
      var titleTag = btn.getAttribute("data-title-tag") || "h3";
      var excerptLength = btn.getAttribute("data-excerpt-length") || "25";
      var showReadMore = btn.getAttribute("data-show-read-more") === "yes" ? "yes" : "no";
      var readMoreText = btn.getAttribute("data-read-more-text") || "Leer más »";
      ...
      params.append("show_title", showTitle);
      params.append("title_tag", titleTag);
      params.append("excerpt_length", excerptLength);
      params.append("show_read_more", showReadMore);
      params.append("read_more_text", readMoreText);
